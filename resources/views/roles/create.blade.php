...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            ...
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Role</h2>
            <p class="text-sm text-gray-500 mt-1">Buat peran pengguna baru dan tentukan hak aksesnya.</p>
        </div>
    ...
    <form action="{{ route('roles.store') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center gap-2">
                <i class="material-icons text-indigo-500">verified_user</i>
                <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Konfigurasi Role</h3>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-bold text-sm text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-md transition">
                    <i class="material-icons text-lg mr-2">save</i> Simpan Role
                </button>
            </div>
        </div>
    </form>

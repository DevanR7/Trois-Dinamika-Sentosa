...
@section('content')
    ...
    <div class="text-center mb-8">
        {{-- Teks Mobile --}}
        <div class="lg:hidden">
            <h4 class="text-xl font-bold text-[#0f172a] dark:text-white">Internal Portal</h4>
        ...
        <div class="hidden lg:block">
            ...
            <p class="text-sm text-slate-500">Silakan login sebagai staf untuk melanjutkan</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login') }}" class="space-y-5">
        ...
        {{-- Username --}}
        <div>
            <label for="username" class="block mb-1.5 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Username</label>
        ...
        <div class="flex items-center justify-between mt-1">
            ...
            @if (Route::has('admin.password.request'))
                <a href="{{ route('admin.password.request') }}" class="text-xs font-bold text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 transition-colors duration-300">
                    Lupa password?
                </a>
            @endif
        </div>
        ...
        <div class="text-center mt-6 pt-2">
            <p class="text-xs text-slate-400">
                Klien Eksternal? 
                <a href="{{ route('client.login') }}" class="font-bold text-[#0f172a] hover:underline dark:text-indigo-400 transition-colors duration-300">Masuk disini</a>
            </p>
        </div>

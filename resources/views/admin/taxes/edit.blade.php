    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <nav class="flex text-sm text-slate-500 mb-1">
                <a href="{{ route('admin.taxes.index') }}" class="hover:text-indigo-600 transition-colors">Pajak</a>
                <span class="mx-2 text-slate-300">/</span>
                <span class="text-slate-800 font-semibold">Edit</span>
            </nav>
            <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Edit Tarif Pajak</h1>
        </div>
        ...
        <div class="dashboard-card p-0 overflow-hidden shadow-lg border-0 ring-1 ring-slate-900/5">
            ...
            <div class="px-6 py-4 bg-indigo-50 border-b border-indigo-100 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-indigo-600">Pajak saat ini: <span class="font-bold">{{ $tax->name }}</span></p>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="relative w-full sm:w-1/2">
                        <input type="number" step="0.01" name="rate" id="rate" value="{{ old('rate', $tax->rate) }}" 
                               class="form-input pr-10 font-bold text-right text-indigo-600" required>
                ...
                <div class="pt-4 border-t border-slate-100">
                    <label class="flex items-start gap-3 cursor-pointer group">
                        ...
                        <div>
                            ...
                            <span class="block text-xs text-slate-500 mt-0.5">Jika non-aktif, pajak tidak muncul di pilihan.</span>
                        </div>
                    </label>
                </div>
            </div>

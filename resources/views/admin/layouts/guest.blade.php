...
<head>
    ...
    {{-- VITE --}}
    @vite(['resources/css/admin/app.css', 'resources/css/pages/auth.css', 'resources/js/admin/app.js'])
        ...
        <div class="hidden lg:flex flex-col justify-between p-12 bg-[#0f172a] text-white h-full relative">
            ...
            <div class="flex flex-col justify-center space-y-4 my-auto">
                <h1 class="text-4xl font-bold leading-tight tracking-tight">
                    Internal Portal <br> <span class="text-indigo-400">System</span>
                </h1>
                <div class="w-12 h-1 bg-indigo-500 rounded-full"></div>
                <p class="text-slate-300 text-sm leading-relaxed max-w-sm">
                    Portal khusus staf untuk mengelola sistem operasional, manajemen proyek, dan memantau kinerja perusahaan secara realtime.
                </p>
            </div>
            <div class="border-t border-slate-700/50 pt-6 mt-auto">
                <div class="flex flex-col">
                    <span class="text-[10px] text-slate-400 uppercase tracking-widest mb-1">Waktu Server</span>

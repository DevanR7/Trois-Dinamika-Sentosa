...
<div class="max-w-4xl mx-auto pb-20 animate-enter">
    ...
    <form action="{{ route('admin.loans.update', $loan) }}" method="POST" id="loan-form">
        @csrf
        @method('PUT')
        ...
        <div class="dashboard-card p-0 overflow-hidden shadow-lg border-0 ring-1 ring-slate-900/5">
            ...
            <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                <a href="{{ route('admin.loans.index') }}" class="h-[48px] px-6 bg-white border border-slate-300 text-slate-600 rounded-lg text-sm font-bold hover:bg-slate-50 transition-all flex items-center justify-center shadow-sm">
                    Batal
                </a>

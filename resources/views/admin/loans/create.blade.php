...
<div class="max-w-4xl mx-auto pb-20 animate-enter">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <nav class="flex items-center gap-2 text-sm text-slate-500 mb-1">
                <a href="{{ route('admin.loans.show', $loan) }}" class="hover:text-indigo-600 transition-colors">Detail Pinjaman</a>
    ...
    <form action="{{ route('admin.loans.payments.store', $loan) }}" method="POST" id="payment-form">
        @csrf
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="principal_paid_display" class="form-input input-currency pl-10 text-lg font-bold text-slate-800 font-mono" placeholder="0" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="interest_paid_display" class="form-input input-currency pl-10 text-lg font-bold text-red-600 font-mono" placeholder="0">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // AutoNumeric dan input hidden sync
        ...
        // Global init dari app.js sudah jalan untuk class .input-currency, 
        // kita hanya perlu listener untuk update hidden input
        ...
        document.getElementById('payment-form').addEventListener('submit', function(e) {
            ...
            if (principal > maxPayment) {
                e.preventDefault();
                // Format Rupiah manual untuk pesan error (karena simple)

...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Form Card --}}
        <div class="card">
            <form action="{{ route('admin.suppliers.update', $supplier->supplier_id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="supplier_name" value="{{ old('supplier_name', $supplier->supplier_name) }}" 
                                   class="form-input pl-10 @error('supplier_name') border-red-500 @enderror" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="person_in_charge" value="{{ old('person_in_charge', $supplier->person_in_charge) }}" 
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="address" rows="2" class="form-input pl-10">{{ old('address', $supplier->address) }}</textarea>
                        </div>
                    </div>

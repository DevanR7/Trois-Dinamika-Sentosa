        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white flex items-center gap-2">
                    <i class="material-icons text-indigo-500">person_add</i> Supplier Baru
                </h1>
                <p class="text-sm text-slate-500 dark:text-slate-400">Daftarkan mitra pemasok baru ke dalam sistem.</p>
            </div>
            <div class="flex gap-2">
                ...
                <button type="submit" class="btn btn-primary shadow-lg shadow-indigo-500/30">
                    <i class="material-icons text-sm">save</i> Simpan Data
                </button>
            </div>
        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="supplier_name" 
                                       ...
                                       placeholder="Contoh: PT. Sumber Makmur Jaya" required autofocus>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="address" class="form-textarea pl-10" rows="3" 
                                          placeholder="Alamat kantor atau gudang supplier...">{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card p-6 h-full border-t-4 border-t-indigo-500">
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-lg mb-5 flex gap-3 items-start">
                        ...
                        <p class="text-xs text-indigo-700 dark:text-indigo-300 leading-snug">
                            Data ini digunakan otomatis saat pembuatan bukti transfer pelunasan hutang.
                        </p>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                {{-- Icon ditaruh di luar select jika pakai TomSelect, atau diabaikan --}}
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        // Init TomSelect untuk Bank
        document.querySelectorAll('.tom-select').forEach(el => {
            new TomSelect(el, {
                create: true, // Izinkan user ngetik nama bank baru jika tidak ada di list

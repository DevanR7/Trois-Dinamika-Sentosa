            ...
            <div class="dashboard-card p-0 overflow-hidden shadow-lg border-0 ring-1 ring-slate-900/5 min-h-[500px]">
                ...
                <div class="p-6 md:p-8 bg-white">
                    ...
                    <div id="password-tab" class="tab-content hidden animate-enter">
                        ...
                        <form method="post" action="{{ route('admin.password.update') }}" class="space-y-6 max-w-lg">
                            @csrf
                            @method('put')
...
<form id="delete-account-form" action="{{ route('admin.profile.destroy') }}" method="POST" class="hidden">
    @csrf
    @method('delete')

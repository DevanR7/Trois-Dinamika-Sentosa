...
<div class="max-w-7xl mx-auto pb-20 animate-enter">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="stock_quantity" value="{{ old('stock_quantity', (float)$product->stock_quantity) }}" class="form-input"step="0.01" min="0">
                            </div>
                        </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="p-6">
                        <div class="relative w-full aspect-square bg-slate-50 rounded-xl border-2 border-dashed border-slate-300 hover:border-indigo-400 hover:bg-indigo-50/10 transition-all group cursor-pointer overflow-hidden flex flex-col items-center justify-center text-center {{ $product->image_path ? 'border-none' : '' }}" id="upload-area">
                            ...
                            <input type="file" name="image" id="image" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" accept=".png, .jpg, .jpeg">
    ...
    @can('delete', $product)
    <form id="delete-form-main" action="{{ route('admin.products.destroy', $product->product_id) }}" method="POST" class="form-confirm hidden">
        @csrf @method('DELETE')
        <button type="submit" 

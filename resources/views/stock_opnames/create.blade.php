    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <nav class="flex text-sm text-slate-500 mb-1">
                <a href="{{ route('stock-opnames.index') }}" class="hover:text-indigo-600 transition-colors">Riwayat Opname</a>
        ...
        <div class="dashboard-card p-0 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-end gap-3 mt-6 pt-6 border-t border-slate-100">
                    <a href="{{ route('stock-opnames.index') }}" class="h-[48px] px-6 bg-white border border-slate-300 text-slate-600 rounded-lg text-sm font-bold hover:bg-slate-50 transition-all flex items-center justify-center shadow-sm">
                        Batal
                    </a>

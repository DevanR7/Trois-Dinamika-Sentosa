...
<body>
    ...
    <script>
        function updateClock() {
            ...
            if (clockElement) {
                // Format Tanggal (misal: Senin, 20 Oktober 2025)
                const dateOptions = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
                const formattedDate = now.toLocaleDateString('id-ID', dateOptions); // Gunakan locale Indonesia

                // Format Waktu (misal: 21:55:28)
                const timeOptions = { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false, timeZone: 'Asia/Jakarta' }; // Set timezone WIB
                const formattedTime = now.toLocaleTimeString('id-ID', timeOptions).replace(/\./g,':'); // Ganti . jadi :

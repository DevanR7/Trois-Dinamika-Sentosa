...
<div class="max-w-7xl mx-auto pb-20 animate-enter">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Verifikasi Pembayaran Batch</h1>
            <p class="text-slate-500 text-sm mt-1">Daftar pembayaran batch yang menunggu konfirmasi (Pending).</p>
        </div>
        <a href="{{ route('batch-payments.create') }}" class="h-[48px] px-8 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-bold shadow-md transition-all flex items-center justify-center gap-2 group hover:-translate-y-0.5">
    ...
    <div class="space-y-4">
        ...
        @empty
            <div class="dashboard-card p-12 text-center flex flex-col items-center justify-center">
                ...
                <p class="text-slate-500 text-sm mt-1 max-w-xs">Semua pembayaran batch telah diproses.</p>
            </div>
        @endforelse
    </div>

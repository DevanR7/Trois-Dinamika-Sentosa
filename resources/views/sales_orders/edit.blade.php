        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-success text-white">
                    ...
                    <h4 class="mb-0">Edit Pesanan: {{ $order->order_number }}</h4>
                </div>
                    ...
                    <form action="{{ route('sales-orders.update', $order->order_id) }}" method="POST">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-6">
                                ...
                                {{-- ✅ BERUBAH: $salesOrder -> $order --}}
                                <textarea class="form-control" name="notes" id="notes" rows="3">{{ old('notes', $order->notes) }}</textarea>
                            </div>
...
<template id="product-row-template">
    {{-- Template ini tidak berubah, sudah benar --}}
    <tr>
        <td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function addProductRow(item = null) {
        ...
        if (item) {
            ...
            // Menggunakan harga historis dari item
    ...
    // ✅ BERUBAH: salesOrderItems -> orderItems

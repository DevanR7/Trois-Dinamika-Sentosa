...
<div class="container-fluid py-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1">Edit Metode Pembayaran</h3>
            <p class="text-muted mb-0 small">Perbarui konfigurasi metode: <span class="text-primary fw-bold">{{ $paymentMethod->name }}</span></p>
        </div>
        <div>
            ...
            <form action="{{ route('payment-methods.update', $paymentMethod->payment_method_id) }}" method="POST">
                ...
                <div class="card card-transaction border-0 shadow-sm">
                    <div class="card-header bg-white p-4 border-bottom">
                        <div class="form-section-title mb-0"><i class="bi bi-pencil-square"></i> Edit Data Metode</div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-end pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-success px-4 fw-bold">Update Metode</button>
                        </div>
                    </div>
                </div>
            </form>

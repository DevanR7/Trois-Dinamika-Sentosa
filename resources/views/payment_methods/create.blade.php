...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            ...
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Metode</h2>
            <p class="text-sm text-gray-500 mt-1">Buat opsi pembayaran baru untuk transaksi.</p>
        </div>
    ...
    <form action="{{ route('payment-methods.store') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center gap-2">
                ...
                <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Form Data Metode</h3>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-input block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Contoh: Transfer BCA, Giro Mundur" required>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Pilih "Pending" jika pembayaran butuh proses pencairan (seperti Cek/Giro).</p>
                </div>

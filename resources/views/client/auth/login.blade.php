...
@section('content')
    ...
    <div class="text-center mb-8">
        {{-- Mobile Text Header (ID Secret Trigger disini) --}}
        <div class="lg:hidden">
            <h4 class="text-xl font-bold text-[#0f172a] dark:text-white select-none" id="secret-trigger-mobile">Client Portal</h4>

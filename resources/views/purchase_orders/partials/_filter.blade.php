<form action="{{ route('purchase-orders.index') }}" method="GET">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
        ...
        <div class="md:col-span-3 flex gap-2">
            ...
            <a href="{{ route('purchase-orders.index') }}" class="px-3 py-2 bg-white border border-gray-300 rounded-md text-gray-500 hover:text-indigo-600 hover:border-indigo-300 transition flex items-center justify-center" title="Reset Filter">

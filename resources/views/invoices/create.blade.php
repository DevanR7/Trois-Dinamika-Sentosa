            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route("invoices.store") }}" method="POST">
                        @csrf
                        {{-- ✅ BERUBAH: isset($salesOrder) -> isset($order) --}}
                        @if (isset($order))
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="client_id" id="client_id" class="form-select" required>
                                    ...
                                    @foreach ($clients as $client)
                                        {{-- ✅ BERUBAH: isset($salesOrder) -> isset($order) & $salesOrder->client_id -> $order->client_id --}}
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="user_id_sales" id="user_id_sales" class="form-select">
                                    ...
                                    @foreach ($salesUsers as $sales)
                                        {{-- ✅ BERUBAH: isset($salesOrder) -> isset($order) & $salesOrder->user_id_sales -> $order->user_id_sales --}}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ✅ BERUBAH: Menggunakan 'orderClientId'
    if (orderClientId) {
    ...
    // ✅ BERUBAH: Menggunakan 'orderItems'

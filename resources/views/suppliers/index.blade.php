...
<div class="max-w-6xl mx-auto pb-20 animate-enter">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-wrap gap-2 w-full md:w-auto">
            ...
            @else
                <a href="{{ route('suppliers.index', ['status' => 'deleted']) }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                    ...
                    <div class="flex flex-col gap-2 justify-center md:border-l md:border-slate-200 md:pl-6">
                        @if($supplier->trashed())
                            ...
                            <form action="{{ route('suppliers.restore', $supplier->supplier_id) }}" method="POST" class="form-confirm w-full">
                                @csrf @method('PATCH')
                                <button type="submit" 
                        ...
                        @else
                            ...
                            {{-- Tombol ARSIP (Merah) --}}
                            <form action="{{ route('suppliers.destroy', $supplier->supplier_id) }}" method="POST" class="form-confirm w-full">
                                @csrf @method('DELETE')
                                <button type="submit" 

...
<div class="container-fluid py-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1">Tambah Supplier Baru</h3>
            <p class="text-muted small mb-0">Masukkan data vendor atau pemasok baru.</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card card-transaction border-0 shadow-sm">
                <div class="card-header bg-white p-4 border-bottom">
                    <div class="form-section-title mb-0"><i class="bi bi-person-plus"></i> Informasi Supplier</div>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('suppliers.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="supplier_name" class="form-label fw-bold small text-muted">NAMA SUPPLIER <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="person_in_charge" name="person_in_charge" value="{{ old('person_in_charge') }}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4 fw-bold">Simpan Supplier</button>
                        </div>
                    </form>
                </div>
            </div>

    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <nav class="flex text-sm text-slate-500 mb-1">
                <a href="{{ route('purchase-returns.index') }}" class="hover:text-indigo-600 transition-colors">Retur Pembelian</a>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="dashboard-card p-6 shadow-lg sticky top-6 border-t-4 border-indigo-500">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="{{ route('purchase-returns.index') }}" class="w-full h-[48px] bg-white border border-slate-300 text-slate-700 text-sm font-bold rounded-lg hover:bg-slate-50 transition text-center shadow-sm flex items-center justify-center">
                            Batal
                        </a>
                    </div>
                </div>

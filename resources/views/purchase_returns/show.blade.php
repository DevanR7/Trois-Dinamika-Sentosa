    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <nav class="flex text-sm text-slate-500 mb-1">
                <a href="{{ route('purchase-returns.index') }}" class="hover:text-indigo-600 transition-colors font-medium">Retur Pembelian</a>
        ...
        <a href="{{ route('purchase-returns.index') }}" class="h-[48px] px-6 bg-white border border-slate-300 rounded-lg text-slate-700 text-sm font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-2 shadow-sm">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex flex-wrap items-center gap-2">
                                ...
                                <a href="{{ route('purchase-orders.show', $purchaseReturn->purchase_order_id) }}" class="text-xs font-bold text-indigo-600 hover:underline font-mono bg-indigo-50 px-2 py-1 rounded border border-indigo-100">

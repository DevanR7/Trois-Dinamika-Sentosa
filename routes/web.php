...
// Grup untuk semua halaman yang hanya bisa diakses setelah login
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Resource Route untuk semua fitur aplikasi Anda
    Route::resource('users', UserController::class);
    Route::resource('products', ProductController::class);
    Route::resource('sales-orders', SalesOrderController::class);
    Route::resource('invoices', SalesInvoiceController::class);
    // Tambahkan resource lain jika ada di sini
    ...
    Route::post('purchase-orders/{purchaseOrder}/mark-as-paid', [PurchaseOrderController::class, 'markAsPaid'])
    ->name('purchase-orders.markAsPaid');
    ...
    Route::post('purchase-orders/{purchaseOrder}/add-supplier-invoice', [PurchaseOrderController::class, 'addSupplierInvoice'])
    ->name('purchase-orders.addSupplierInvoice');
    Route::get('/purchase-orders/{id}/export-excel', [PurchaseOrderController::class, 'exportExcel'])
    ->name('purchase-orders.exportExcel');
});

// Route untuk file autentikasi (login, register, dll)

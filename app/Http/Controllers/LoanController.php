...
{   
    ...
    public function create(): View
    {
        ...
        return view('loans.create', compact('loanAccounts', 'cashAccounts'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('loans.index')->with('success', 'Data pinjaman baru berhasil disimpan dan dijurnal.');
    ...
    public function edit(Loan $loan): View
    {
        ...
        return view('loans.edit', compact('loan', 'loanAccounts', 'cashAccounts'));
    }
